export const MESSAGES = {
  ...
  MODAL: {
    ...
    CONFIG_LABEL_TOKEN: '访问令牌 (Personal Access Token)',
    EXPORT_DATA: '导出备份',
    IMPORT_DATA: '恢复备份',
    ...
    SITE_URL_PLACEHOLDER: '网址 (如: google.com)',
    SITE_ICON_PLACEHOLDER: '自定义图标代码 (可选)',
  },
  ...
  ERRORS: {
    ...
    CONFLICT: '数据版本冲突',
    PUSH_FAILED: '推送失败，请检查网络连接',
    NETWORK_ERROR: '网络连接异常',
    FORBIDDEN: '无权访问 (403)，请检查 Token 权限',
    NOT_FOUND: '资源不存在',
    SERVER_ERROR: 'GitHub 服务端错误',
    UNKNOWN: '未知网络错误'
  }
} as const;