  ...
  <header class="w-full flex flex-col md:flex-row justify-between items-center gap-5">
    ...
    <div class="relative w-full md:w-[480px]">
      <Input 
        ...
        placeholder="Search..."
      />
      <svg onclick={handleSearch} class="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-text-dim cursor-pointer hover:text-primary transition-colors" fill="none" stroke="currentColor" viewBox={ICONS.search.viewBox}>
