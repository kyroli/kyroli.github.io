...
{#if appState.tooltip && appState.tooltip.visible}
  <div
    ...
    "
  >
    <div class="px-3 py-1.5 bg-text text-bg text-xs rounded-lg font-bold tracking-wide shadow-float animate-fade max-w-[200px] text-center text-balance leading-relaxed">
